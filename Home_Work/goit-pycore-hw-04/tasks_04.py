...
# Створимо функцію, щоб розбирати введений рядок на команду та аргументи
...
# Створимо функцію, щоб додавати новий контакт до словника. 
...
# Створимо функцію, щоб змінювати номер телефону існуючого контакту. 
...
# Створимо функцію, щоб показувати номер телефону вказаного контакту. 
...
# Створимо функцію, щоб показувати всі збережені контакти.
def show_all(contacts: dict) -> str:
    if not contacts:
        return "No contacts saved."
    
    # Створюємо один рядок з усіма контактами
    result = ""
...
# Створимо функцію, щоб керувати основним циклом запит-відповідь бота.
def main():
    contacts = {}
    print("Welcome to the assistant bot!")
    while True:
